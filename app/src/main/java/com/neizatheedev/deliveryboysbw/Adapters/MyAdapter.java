...
import com.neizatheedev.deliveryboysbw.Activities.ProductDetails;
import com.neizatheedev.deliveryboysbw.R;
import com.neizatheedev.deliveryboysbw.Activities.UpdateProductDetails;
...
public class MyAdapter extends PagerAdapter implements View.OnClickListener  {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        dialog.setContentView(R.layout.activity_update_product_details);
